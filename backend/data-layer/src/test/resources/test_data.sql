...
VALUES ('amogus1', 1, 123, 'ACTIVE', 2018615, 1, 2, 3, 4);

INSERT INTO peer_data(login, wave, tribe_id, state, tribe_points, exp_value, peer_review_points, code_review_points, coins)
VALUES ('amogus2', 2, 123, 'ACTIVE', 2018615, 4, 5, 6, 7);

INSERT INTO peer_data(login, wave, tribe_id, state, tribe_points, exp_value, peer_review_points, code_review_points, coins)
VALUES ('amogus3', 3, 123, 'ACTIVE', 2018615, 7, 8, 9, 10);

INSERT INTO peer_data(login, wave, tribe_id, state, tribe_points, exp_value, peer_review_points, code_review_points, coins)
VALUES ('abobus1', 1, 321, 'ACTIVE', 20181116, 10, 11, 12, 13);

INSERT INTO peer_data(login, wave, tribe_id, state, tribe_points, exp_value, peer_review_points, code_review_points, coins)
VALUES ('abobus2', 2, 321, 'ACTIVE', 20181116, 13, 14, 15, 16);

INSERT INTO peer_data(login, wave, tribe_id, state, tribe_points, exp_value, peer_review_points, code_review_points, coins)
VALUES ('abobus3', 3, 321, 'ACTIVE', 20181116, 16, 17, 18, 19);
