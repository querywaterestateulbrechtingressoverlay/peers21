package ru.cyphercola.peers21.backend.security;

import ru.cyphercola.peers21.backend.data.ApiUserRepository;
import ru.cyphercola.peers21.backend.data.PeerDataRepository;
...
public class CustomUserDetailsService implements UserDetailsService {
  ...
  public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
    LoggerFactory.getLogger(CustomUserDetailsService.class).info("load user by username");
